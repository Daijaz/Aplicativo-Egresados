$(document).ready(function () {
    ...
    var tabla = $('#tabla').DataTable({
        ...
        "ajax": {
            "url": "../controlador/GestionController.php",
    ...
    $(document).on('click', '.btn-crear', (e) => {
        ...
        $('#tit_ven').html('Creacion de Gestiones ');
        edit = false;
    });
    ...
    function buscar(dato) {
        funcion = 'buscar';
        $.post('../controlador/GestionController.php', { dato, funcion }, (response) => {
    ...
    $('#form-crear').submit(e => {
        ...
        $.post('../controlador/GestionController.php', { id, nombre, funcion }, (response) => {
            ...
            if (response === 'add' || response === 'update') {
                Swal.fire({
                    ...
                    text: edit ? 'La gestión se ha actualizado correctamente.' : 'La gestión se ha creado correctamente.',
    ...
    $(document).on('click', '.eliminar', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.post('../controlador/GestionController.php', { id, funcion }, (response) => {
                    response = response.trim(); // Elimina espacios en blanco alrededor de la cadena
