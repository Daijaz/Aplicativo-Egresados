...
$_pag = 'Agregar titulos a egresados';
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><span id="tit_ven">Crear título a egresado</span> </h5>
      ...
      <div class="modal-body">
        ...
        <form id="form-crear">
          <div class="form-group">
            ...
            <select name="id" id="id" class="form-control select2" style="width: 100%"></select>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="datetime" name="fechaGrado" id="fechaGrado" class="form-control" style="width: 100%"></input>
          </div>
        ...
        <div class="col-sm-6">
          <h1><?php echo $_pag; ?>
            <button class="btn-crear btn bg-gradient-primary btn-sm m-2" data-toggle="modal"
              data-target="#crear">Agregar título a egresado</button>
          </h1>
        </div>
        <div class="col-sm-6">
      ...
      <div class="col-12">
        <div class="card card-secondary">
          <div class="card-header">
            <h3 class="card-title">Titulos de Egresados</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
...
?>
<script src="../assets/js/tituloEgresado.js"></script>